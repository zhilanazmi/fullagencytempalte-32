          ...
          {isMobile ? <Sheet>
              ...
              <SheetContent side="right" className="w-[300px] sm:w-[400px]">
                <nav className="flex flex-col gap-4 mt-8">
                  <span onClick={handleBrowseClick} className="text-foreground hover:text-primary cursor-pointer py-2">
                    Browse templates
                  </span>
                  <span className="text-foreground hover:text-primary cursor-pointer py-2">
                    Get a free quote
                  </span>
                  <span className="text-foreground hover:text-primary cursor-pointer py-2">
                    Book an intro call
            ...
            </Sheet> : <Button variant="hero" size="default" className="text-white/50 text-sm font-mono font-normal uppercase tracking-[1.4px] leading-5" onClick={handleGetQuoteClick}>
              GET A FREE QUOTE
            </Button>}
        </div>
      </div>
